...
BEGIN {
    ...
    require '/Users/lucreveyron/Documents/Perso/Code/password-manager/lib/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/lucreveyron/Documents/Perso/Code/password-manager/lib/openssl/test/fips-and-base.cnf';
    shift;
